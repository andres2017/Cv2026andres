const portfolioData = {
  en: {
    ...
    about: {
      ...
      bio: "Systems Engineer with 9+ years protecting critical government infrastructure at INPEC. I combine deep experience in cybersecurity and systems administration with practical expertise in Generative AI, Claude, Skills and Agents. I help companies adopt AI in a secure and useful way — while remaining open to remote roles where I can contribute both security and AI capability.",
      stats: [
      ...
      items: [
        {
          ...
          period: "2015 – Present",
          duration: "9+ years",
          description: "Responsible for information security and IT infrastructure of critical government facilities. Design, implement and maintain secure networks, harden systems and respond to security incidents across multiple sites. Currently expanding into AI enablement and secure AI practices for organizations.",
          highlights: [
      ...
      items: [
        {
          ...
          duration: "9+ años",
          description: "Responsable de la seguridad de la información e infraestructura TI de instalaciones gubernamentales críticas. Diseño, implementación y mantenimiento de redes seguras, hardening de sistemas y respuesta a incidentes. Actualmente expandiendo hacia enablement de IA y prácticas de IA segura para organizaciones.",
          highlights: [
